...
function Scroll(el, options) {
	...
	// ==================================
		...
		$(this.scroller.children[this.options.current]).addClass('current');
		$(this.nav.children[this.options.current]).addClass('current');
	...
	if(this.options.current){
		this.scrollTo(-this.itemWidth*this.options.current, 0);
	}else{
